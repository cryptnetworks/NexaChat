...
The initial Compose file is for development services only. Release images, migration automation, SBOM generation, signing, scanning, and an update procedure are Phase 0 exit work.
